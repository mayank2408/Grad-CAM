# Grad-CAM
Explaining decisions of neural networks is an active area of research. Grad-CAM is a very popular tool that is used to analyse results of CNN model for classification tasks. 
